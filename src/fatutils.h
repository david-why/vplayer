...
/**
 * Gets the FAT structure.
 * 
 * @returns The current FAT structure.
 */
fat_t *fatutil_GetFAT();

/**
 * Retrieves the status of the drivers.
 *
 * @returns Init status: 0=not inited, 1=inited
 */
bool fatutil_GetInit();
 ...
 *
 * @returns Error status: 0=success, 1=pos>size, 2=other error
 */
